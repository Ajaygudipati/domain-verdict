...
export default function Login() {
  ...
  const finishGoogleSignIn = useCallback(async (credential) => {
    ...
    try {
      ...
      if (!response.ok) throw new Error(typeof payload.detail === "string" ? payload.detail : "Google sign-in failed.");
